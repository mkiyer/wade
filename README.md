...
These figures are generated by [`notebooks/demo.qmd`](notebooks/demo.qmd), which
is also where the numbers quoted here come from: `quarto render notebooks/demo.qmd`.

The first two genes have the **same log₂ fold change** (+1.01 and +1.00). The
